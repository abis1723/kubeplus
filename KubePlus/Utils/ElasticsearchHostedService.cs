...
namespace KubePlus.Utils
{
    ...
    public class ElasticsearchHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            var defaultIndex = "studentmanagement";
            ...
            if ((await _elasticClient.Indices.ExistsAsync(defaultIndex)).Exists)
                await _elasticClient.Indices.DeleteAsync(defaultIndex);

            var createMoviesIndexResponse = await _elasticClient.Indices.CreateAsync(defaultIndex, c => c
                .Settings(s => s
                    .Analysis(a => a
                        .TokenFilters(tf => tf
